...
public:
    ...
    void setupUi(QWidget *comForm)
    {
        ...
        comForm->resize(1000, 800);
        comForm->setStyleSheet(QStringLiteral(""));
    ...
    void retranslateUi(QWidget *comForm)
    {
        ...
        label->setText(QApplication::translate("comForm", "\344\270\262\345\217\243", 0));
        label_2->setText(QApplication::translate("comForm", "\346\263\242\347\211\271\347\216\207", 0));
        BaudBox->clear();
        BaudBox->insertItems(0, QStringList()
         << QApplication::translate("comForm", "115200", 0)
         << QApplication::translate("comForm", "19200", 0)
         << QApplication::translate("comForm", "14400", 0)
         << QApplication::translate("comForm", "9600", 0)
         << QApplication::translate("comForm", "2400", 0)
         << QApplication::translate("comForm", "1800", 0)
        );
        label_3->setText(QApplication::translate("comForm", "\346\225\260\346\215\256\344\275\215", 0));
        BitBox->clear();
        BitBox->insertItems(0, QStringList()
         << QApplication::translate("comForm", "8", 0)
         << QApplication::translate("comForm", "5", 0)
        );
        label_4->setText(QApplication::translate("comForm", "\346\240\241\351\252\214\344\275\215", 0));
        ParityBox->clear();
        ParityBox->insertItems(0, QStringList()
         << QApplication::translate("comForm", "0", 0)
         << QApplication::translate("comForm", "1", 0)
        );
        label_5->setText(QApplication::translate("comForm", "\345\201\234\346\255\242\344\275\215", 0));
        StopBox->clear();
        StopBox->insertItems(0, QStringList()
         << QApplication::translate("comForm", "1", 0)
         << QApplication::translate("comForm", "2", 0)
        );
        OpenSerialButton->setText(QApplication::translate("comForm", "\346\211\223\345\274\200\344\270\262\345\217\243", 0));
        closeSerialButton->setText(QApplication::translate("comForm", "\345\205\263\351\227\255\344\270\262\345\217\243", 0));
